...
classesFile = "thisisonyou_obj.names"
classes = None
...
# Model configuration
modelConf = 'cfg_tiny.cfg'
modelWeights = 'peters-5.2.6.weights'
...
def drawPred(classId, conf, left, top, right, bottom):
    ...
    # TODO: A New Way to Calculate the Physical Height
